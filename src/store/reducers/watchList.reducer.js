import { ADD_ANIME_WATCHLIST, FETCH_ANIME_WATCH, REMOVE_ANIME_WATCHLIST } from "../actions/watchList.action";
...
const WatchListReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case FETCH_ANIME_WATCH:
            return {
                ...state,
                watchListAnimes: action.animeWatch,
            };
        default:
            return state;
    }
